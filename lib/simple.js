...
`.trim()
    ...
    */
    ...
    async sendButtonImage(jid, content, buffer, footer, button1, row1, options = {}) {
      ...
      await this.sendMessage(jid, buttonMessage, MessageType.buttonsMessage, {
        ...options
      	...
      	if (e.toString().includes("marker")) return this.sendButtonImg(jid, content, url, footer, button1, row1, options)
      }
    }
 ...
 */
     ...
     * @param {Object} option
     */
    async sendContact(jid, nomor, nama, option = {}) {
