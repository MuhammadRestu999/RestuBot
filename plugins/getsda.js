...
global.DATABASE._data.users[m.sender].lastsda == undefined ? global.DATABASE._data.users[m.sender].lastsda = 0 : global.DATABASE._data.users[m.sender] = global.DATABASE._data.users[m.sender]

let __timers = (new Date - global.DATABASE.data.users[m.sender].lastsda)
        let _timers = (480000 - __timers) 
        let timers = clockString(_timers)

if ( user.created == false || user.created == undefined ) throw 'g punya kerajaan'
