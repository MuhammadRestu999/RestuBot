...
fs.watchFile(file, () => {
  fs.unwatchFile(file)
  console.log(chalk.redBright("Update 'lib/function.js'"))
  delete require.cache[file]
  global.Ft = require(file)
})
