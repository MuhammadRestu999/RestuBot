...
let handler = async (m, { conn, usedPrefix }) => {
    ...
    //let logo = fs.readFileSync("./lib/logo.jpg")
    let logo = "./lib/logo.jpg"
    /// sosial media\\
...
conn.send2ButtonImg( m.chat, tes, avtar, `©RestuBot`, `Kembali`, '+menu', `Partner`, '+creator', {
    ...
    contextInfo: {
        externalAdReply: {
            ...
            mediaType: 2,
          thumbnailUrl: "https://user-images.githubusercontent.com/88314302/131332636-2639910c-d015-4fd5-807d-d5a677a53626.jpg",
         mediaUrl: urlyt
        }
    }
})
